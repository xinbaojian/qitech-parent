...
public class MysqlGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/qitech-oauth2-server/src/main/java");
        gc.setAuthor("xinbj");
        //是否覆盖 默认false
...
//        pc.setModuleName(scanner("模块名"));
        pc.setParent("com.qitech.qitechoauth2");
        pc.setXml("mapper");
        ...
        strategy.setSuperEntityClass("com.qitech.qitechoauth2.entity.BaseEntity");
        strategy.setEntityLombokModel(true);
        strategy.setSuperControllerClass("com.qitech.qitechoauth2.controller.BaseController");
